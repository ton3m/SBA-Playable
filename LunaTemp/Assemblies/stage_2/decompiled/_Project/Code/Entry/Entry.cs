...
namespace _Project.Code.Entry
{
	public class Entry : MonoBehaviour
	{
		...
		[SerializeField]
		private TutorialFabric _tutorialFabric;

		[SerializeField]
		private StorageFabric _storageFabric;
		...
		private void Awake()
		{
			...
			MoveInput input = new MoveInput(_joystick);
			_characterInstaller.Init(input, _coroutineRunner);
		}

		private void Start()
		{
			IFiniteState tutorial = _tutorialFabric.CreateTutorial();
			tutorial.Enter();
		}
