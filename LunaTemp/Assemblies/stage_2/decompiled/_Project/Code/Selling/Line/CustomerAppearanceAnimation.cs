...
namespace _Project.Code.Selling.Line
{
	public class CustomerAppearanceAnimation : MonoBehaviour
	{
		...
		private void OnEnable()
		{
			...
			TweenerCore<Vector3, Vector3, VectorOptions> anim = _bubble.transform.DOScale(_startBubbleScale, 0.5f);
			_body.transform.localScale = Vector3.zero;
			_body.transform.DOScale(_startBodyScale, 0.5f).Play().OnComplete(delegate
			{
