...
namespace _Project.Code.Entry
{
    ...
    public class EntryPoint : MonoBehaviour
    {
        ...
        [SerializeField] private GameObject _fieldsHolder;

        private CoroutineRunner _coroutineRunner;

        private void Awake()
        {
            var dropper = new Dropper(_itemsCreator.Create);
            var fieldsDropper = CreateFieldsDropper(dropper);
        ...
        private FieldsDropper CreateFieldsDropper(Dropper dropper) =>
            new FieldsDropper(dropper, _fieldsHolder
                .GetComponentsInChildren<Core.Harvesting.Field>(true)
                .ToList());
    }
}