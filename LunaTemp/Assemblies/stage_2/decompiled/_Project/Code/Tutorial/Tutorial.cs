...
namespace _Project.Code.Tutorial
{
	public class Tutorial : IFiniteState
	{
		...
		public Tutorial(ICoroutineRunner coroutineRunner, Func<IStorage> storageCreator, VariableJoystick joystick, IEnable animamtion, GameObject joystickGuide, TutorialArrow arrow, IBuyable tableBuyable)
		{
		...
		{
			IStorage s = _storageCreator?.Invoke();
